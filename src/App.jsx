...
const triggerConfetti = () => {
  ...
  return (
    <>{showResult ? <ResultPage score={score} quizdata={quizdata} handleAgain={handleAgain}/> : <Quiz quizdata={quizdata} currQuestion={currQuestion} handleAns={handleAns} selectedOption={selectedOption} handleNext={handleNext} />}</>
  );
};
